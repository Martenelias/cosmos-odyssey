...
function exploreAllRoutes(currentRoute, allRoutes, routeInfos, providers, endPlanet, visitedPlanets) {
  ...
  for (const route of availableRoutes) {
      ...
      // For each provider, explore the next possible path
      for (const provider of matchingProviders) {
          ...
          if ((!lastFlightEnd || flightStart >= lastFlightEnd) && flightEnd > flightStart) {
              ...
              exploreAllRoutes(newRoute, allRoutes, routeInfos, providers, endPlanet, visitedPlanets);
...
export const processRoutes = (allRoutes, routeInfos, providers, selectedPlanet, selectedEndPlanet) => {
  ...
  exploreAllRoutes(initialRoute, allRoutes, routeInfos, providers, selectedEndPlanet, visitedPlanets);
