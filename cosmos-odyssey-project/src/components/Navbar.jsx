...
const Nav = () => {
  return (
    <Navbar className='bg-background-700 text-tertiary-50 font-exo-2 fixed w-full z-50'>
      ...
      <span className='self-center whitespace-nowrap text-base font-orbitron lg:text-lg'>Cosmos Odyssey</span>
      </Navbar.Brand>
      ...
      <Navbar.Collapse>
        ...
        <NavLink to='/reservations' className='text-lg md:text-base  my-2 py-2 px-4 rounded-lg hover:bg-primary-900'>
          Reservations
        </NavLink>
      </Navbar.Collapse>
    </Navbar>
